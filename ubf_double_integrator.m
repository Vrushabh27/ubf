...
tf = 40;                  % Final simulation time (seconds)
...
m_order = 3;              % Order of the higher-order UBF (m_order >=1)
...
n = 4;%length(f([0;0], [0;0]));    % Number of states (e.g., 2)
m = 2;%length([0;0]);              % Number of control inputs (e.g., 2)
